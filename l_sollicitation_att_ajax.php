...
while ($donnees = $reponse->fetch()) {
    ...
    echo '<td class="text-center"><a href="" class="btn btn-primary btn-rounded btn-sm" data-toggle="modal" data-target="#modalTraiter' . $id . '">Details</a></td>';
    echo '<td class="text-center">' . $pj . '</td>';
    echo '<td class="text-center"><a href="recup_sollicitation.php?id=' . $id . '" class="btn btn-primary btn-rounded btn-sm">Affecter</a></td>';
    echo "<td class='text-center'>";
?>

    <!-- Modal: Traiter form -->
    <div class="modal fade" id="modalTraiter<?= $id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!-- Modal: annuler -->
    <div class="modal fade" id="modalAnnuler<?= $id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog cascading-modal" role="document">
            <!-- Content -->
            <div class="modal-content">
                <!-- Header -->
                ...
                <!-- Body -->
                <div class="modal-body mb-0">
                    <form method="POST" action="annuler_sollicitation.php?id=<?= $id ?>">
                        <div class="row">
                            <div class="form-group shadow-textarea col-12">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn red white-text">Annuler</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    echo '
		<td>
			...
			<a href="m_sollicitation.php?id=' . $id . '"  class="teal-text" data-toggle="tooltip" data-placement="top" title="Modifier"><i class="fas fa-pencil-alt"></i></a><a href=""  data-toggle="modal" class="red-text" data-target="#modalAnnuler' . $id . '"><i class="fas fa-times"></i></a>	
		</td>
		';
