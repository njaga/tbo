              ...
              -->
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
                        ...
                        <a class="dropdown-item" href="#">Salaire(s)<span class="badge bg-danger ms-5"> New</span></a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Affectations
                    </a>
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
                        <a class="dropdown-item" href="l_affectation_employe.php">Nouvelle +</a>
                        <a class="dropdown-item" href="l_affectation_site.php">Affectations Nouvelles </a>
                        <a class="dropdown-item" href="l_affectation_site_ancien.php">Anciennes affectations</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Planning<span class="badge bg-danger ms-5"> New</span>
                    </a>
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
