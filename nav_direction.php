              ...
              -->
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
                        ...
                        <a class="dropdown-item" href="l_taches_r.php">Liste tâches</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sollicitation(s) <span class="badge bg-danger ms-5"> <?= $nbr_en_cour + $nbr_en_att ?></span>
                    </a>
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
                        <a class="dropdown-item" href="sollicitation.php">Enregistrer</a>
                        <a class="dropdown-item" href="l_sollicitation_cours_r.php">En cours <span class="badge bg-danger ms-5"> <?= $nbr_en_cour ?></span></a>
                        <a class="dropdown-item" href="l_sollicitation_att.php">En attente <span class="badge bg-danger ms-5"> <?= $nbr_en_att ?></span></a>
                        <a class="dropdown-item" href="l_sollicitation_close_r.php">Terminer</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
